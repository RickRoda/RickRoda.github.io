...
4. In Command Line, type 'python parser.py'
...
#Initiate empty Dictionary to fill up as we go through the CSV
...
#Bug on Sven due 4th skill. Will look at later
    if record['character'] == 'Sven':
        next(reader)

        ##Cant' Figure this out yet, he messes up the parsing due to having 4 skills on this csv
